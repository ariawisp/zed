...
wasmtime::component::bindgen!({
    ...
    world: "zed-extension:extension/extension@0.5.0",
    with: {
        "worktree": ExtensionWorktree,
        "project": ExtensionProject,
        "key-value-store": ExtensionKeyValueStore,
        "zed-extension:common/common@1.0.0": latest::zed_extension::common::common,
        "zed-extension:github/github@1.0.0": latest::zed_extension::github::github,
        "zed-extension:http-client/http-client@1.0.0": latest::zed_extension::http_client::http_client,
        "zed-extension:lsp/lsp@1.0.0": latest::zed_extension::lsp::lsp,
        ...
        "zed-extension:process/process@1.0.0": latest::zed_extension::process::process,
        "zed-extension:slash-command/slash-command@1.0.0": latest::zed_extension::slash_command::slash_command,
        "zed-extension:context-server/context-server@1.0.0": latest::zed_extension::context_server::context_server,
    },
});
